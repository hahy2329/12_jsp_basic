...
<script>
	function sendData(){
		...
		document.f.submit(); //submit(); 메서드를 사용하여 데이터를 서버로 전송한다.
	...
	<%--
	 ...
	 <form action="formEx01Pro.jsp" method="post" name="f">
	 	<fieldset>
	 		...
	 		<!-- form태그 안에 name값이 서버로 전송된다. -->
	 		<p>이름 : <input type="text" name="name"></p>
	 		<p>연락처 : <input type="text" name="contact"></p>
	 		<p>나이 : <input type="text" name="age"></p>
	 		<!-- submit 타입을 사용하여 전송한다.(일반적으로 사용되는 방법) -->
	 		<p><input type="submit" value="제출하기"></p>
	 		
	 		<!-- 자바스크립트를 이용하여 전송한다.(주로form의 name과 같이 사용한다.) -->
	 		
	 		<p><input type="button" value="제출하기" onclick="sendData()"></p>
	 	</fieldset>
	 </form>
